    ...
    <div>
      <Helmet>
        ...
        <meta
          ...
          content={
            isEnglish
              ? "Reach out to us through our branches across Saudi Arabia and the Egypt. View maps, call, or message via WhatsApp."
              : "تواصل معنا عبر فروعنا المنتشرة في السعودية و مصر. اعرض الخرائط أو اتصل بنا أو راسلنا على واتساب."
          }
        />
        <meta
          name="keywords"
          content={
            isEnglish
              ? "contact us, branch locations, Saudi Arabia, Egypt, WhatsApp, car services, map directions"
              : "تواصل معنا، مواقع الفروع، السعودية، مصر واتساب، خدمات سيارات، خرائط"
          }
        />
        <meta
          property="og:title"
